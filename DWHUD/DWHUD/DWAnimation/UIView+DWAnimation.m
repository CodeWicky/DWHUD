...
{
    return [[DWAnimation alloc] initAnimationWithLayer:self.layer animationType:animationType animationKey:animationKey beginTime:beginTime values:values timeIntervals:timeIntervals transition:transition];
}
...
{
    return [[DWAnimation alloc] initAnimationWithLayer:self.layer animationKey:animationKey beginTime:beginTime duration:duration bezierPath:bezierPath autoRotate:autoRotate];
}
...
{
    return [[DWAnimation alloc] initAnimationWithLayer:self.layer animationKey:animationKey beginTime:beginTime duration:duration arcCenter:center radius:radius startAngle:startAngle endAngle:endAngle clockwise:clockwise autoRotate:autoRotate];
}
